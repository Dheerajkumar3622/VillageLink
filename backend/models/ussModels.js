...
// Daily Schedule - AI/Manual recurring routes
const dailyScheduleSchema = new mongoose.Schema({
    ...
    expectedTime: { type: String, required: true }, // Format HH:MM 24-hr
...
dailyScheduleSchema.index({ location: '2dsphere' });
dailyScheduleSchema.index({ stopName: 1 });
