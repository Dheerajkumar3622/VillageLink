...
import { DynamicFareResult, CrowdForecast, ChurnRiskAnalysis, ChatMessage, DeviationProposal, MandiRate, JobOpportunity, MarketItem, PilgrimagePackage, FuelAdvice, LeafDiagnosisResult, ParcelScanResult } from '@villagelink/shared';
